...
Write-Host "║         🛡️  UNICODE FORTRESS INSTALLATION 🛡️          ║" -ForegroundColor Cyan
Write-Host "║                                                        ║" -ForegroundColor Cyan
...
$repos = @("C:\Projects\kyleh", "C:\AI-Librarian", "C:\repos\AI-Librarian")
...
"@
        ...
        Write-Host "  ⏭️  Not a git repo: $repo" -ForegroundColor Gray
    }
}
...
if (Test-Path $vscodeSettingsPath) {
    ...
    Write-Host "  ⏭️  VSCode not found, skipping" -ForegroundColor Gray
}
...
Write-Host "Your system is now FORTIFIED against Unicode corruption! 🛡️" -ForegroundColor Green
Write-Host ""
